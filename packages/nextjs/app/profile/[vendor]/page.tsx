...
const ViewProfile = ({ params }: { params: { vendor: string } }) => {
  const query = params.vendor;
        ...
        <div className="flex flex-col space-y-4 justify-center">
          <div className="justify-center flex">
            {prof && prof[5] !== undefined ? (
              ...
              <Image src={man} alt={"Profile image"} width={160} height={160} className="rounded-full w-40 h-40 m-2" />
            )}
          </div>
